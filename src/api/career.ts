	...
	experiences: [
		{
			...
			achievements: [
				{
					text: "유니티-웹 간 통신 레이어 제거를 통한 코드 최적화",
					details: [
						{
							text: "기존: 3D 렌더링 → 인터랙션 → Unity 커맨드 → iframe 외부 메시지 전달 → Widget 구조에서 iframe 레이어를 제거하여 통신 단계를 간소화",
						},
						{
							text: "이 과정에서 약 1,200줄의 코드를 삭제하여 프로젝트 가독성 및 유지보수성 향상",
						},
					],
				},
			],
